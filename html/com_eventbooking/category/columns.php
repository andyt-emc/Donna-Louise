...
<div id="eb-category-page-columns" class="eb-container">
	...
	{
	?>
		<div class="eb-category-description clearfix single-col">
			<?php
	...
	{
	?>
		<h2 class="eb-page-heading"><?php echo $this->params->get('page_heading');?></h2>
	<?php
	}
...
<div id="event-below" class="clearfix">
	<?php
	    ...
	    $modules = JModuleHelper::getModules('event-category'); 
